...
for move = 1:moves
    ...
    % Tree expansion:
    best_move_max = minimax_algorithm(parent_max, children_max, leaf_max, dim_max, upperbound_max, lowerbound_min, Ki_max, depth_max, minimax_max, z_max, x_max, r_max, parameters, model_max);
